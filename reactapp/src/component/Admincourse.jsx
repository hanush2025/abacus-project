        ...
        <>
             {
                ...
                
                {
                    ...
                    return(
                            <div class = "container box2  bg-info col-5 mt-5  mb-5 p-3">
                                <Row>
                                    <Col><label class="labal"> CourseId</label></Col>
                                    <Col><label class="labal"> {val.courseId}</label></Col>
                                </Row>
                                <Row>
                                    <Col><label class="labal"> CourseName</label></Col>
                                    <Col><label class="labal"> {val.courseName}</label></Col>
                                </Row>
                                <Row>
                                    <Col><label class="labal"> CourseDuration</label></Col>
                                    <Col><label class="labal"> {val.courseDuration}</label></Col>
                                </Row>
                                <Row>
                                    <Col><label class="labal"> Course Description</label></Col>
                                    <Col><label class="labal"> {val.courseDescription}</label></Col>
                                </Row>
